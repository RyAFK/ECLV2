  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        ...
        <h1 className="mt-3 font-serif-display text-2xl font-semibold text-[var(--text)] sm:text-3xl">Professional education library</h1>
        <p className="mt-1.5 max-w-2xl text-sm text-[var(--text-secondary)]">
          The wider library of clinical resources and CPD events for referring professionals, in addition to the Clinical
          Education modules.
        </p>
      </div>
